		...
		<div class="pagin">
			...
			<ul class="paginList">
				<li class="paginItem"><s:if
					  ...
					  <s:else>
					  <a href="ajfp-list?page=<s:property value="#request.ajfppageBean.currentPage - 1"/>">上一页</a>
					  </s:else>
					</li>
				...
				<li class="paginItem"><s:if
						...
						<a
							href="ajfp-list?page=<s:property value="#request.ajfppageBean.currentPage + 1"/>">下一页</a>
					...
					<li class="paginItem"><s:if test="#request.ajfppageBean.currentPage != #request.ajfppageBean.totalPage-1">
					 <a
							href="ajfp-list.action?page=<s:property value="#request.ajfppageBean.totalPage-1"/>">尾页</a>
					</s:if>
					<s:else>
					<a
