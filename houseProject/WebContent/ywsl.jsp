					...
					<s:iterator value="#request.pageBean.list" status="L">
						<tr>
							...
							<td><input name="caseState" value="${caseState }"
								type="text" class="state" /></td>
							<td><a href="xfdj-input?id=${id }" class="tablelinkEdit">编辑</a>&nbsp;&nbsp;<a
								href="#" class="tablelink">受理</a> <input type="hidden"
								value="${id }" />&nbsp;&nbsp; <a href="ywsl-delete?id=${id }"
								class="tablelinkdelete">删除</a><input type="hidden"
								value="${caseUserName }" /></td>
						</tr>
					</s:iterator>
				</tbody>
			</table>
				...
				<div class="tipinfo">
					<ul class="forminfo">
						...
						<li><label>受理时间<b>*</b></label>
							<div class="cityleft">
								<s:textfield name="acceptDate" onclick="WdatePicker('yyyyMMdd')"
