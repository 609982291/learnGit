	...
	<div class="pagin">
		...
		<ul class="paginList">
			...
			<li class="paginItem"><s:if
					...
					<a
						href="ywdb-list?page=<s:property value="#request.ywdbpageBean.currentPage - 1"/>">上一页</a>
				</s:else></li>
			...
			<li class="paginItem"><s:if
					...
					<a
						href="ywdb-list?page=<s:property value="#request.ywdbpageBean.currentPage + 1"/>">下一页</a>
			...
			<li class="paginItem"><s:if
					test="#request.ywdbpageBean.currentPage != #request.ywdbpageBean.totalPage-1">
					<a
						href="ywdb-list.action?page=<s:property value="#request.ywdbpageBean.totalPage-1"/>">尾页</a>
				</s:if> <s:else>
					<a href="javascript:;">尾页</a>
				</s:else></li>
			<li class="paginItem" style=""><s:form name="ywdb-list?flag=go">
